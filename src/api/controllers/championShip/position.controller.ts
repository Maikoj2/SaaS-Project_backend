...
export class PositionController {
    ...
    public manualAssignPositions = async (req: IUserCustomRequest, res: Response) => {
        try {
            const { championshipId } = req.params;
            const tenant = req.clientAccount as string;
    ...
    public assignPositionByRegistrationId = async (req: IUserCustomRequest, res: Response) => {
        try {
    ...
    public assignRandomPositions = async (req: IUserCustomRequest, res: Response) => {
        try {
            const { championshipId } = req.params;
            const tenant = req.clientAccount as string;
    ...
    public getPositionsByChampionshipId = async (req: IUserCustomRequest, res: Response) => {
        try {
            const { championshipId } = req.params;
            const tenant = req.clientAccount as string;
