...
export class GroupController {
  ...
  public updateGroup = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const group = await this.groupService.updateGroup(parseInt(id), req.body);
  ...
  public deleteGroup = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const deleted = await this.groupService.deleteGroup(parseInt(id));
  ...
  public addTeamToGroup = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.groupService.addTeamToGroup(parseInt(id), team_id);
  ...
  public removeTeamFromGroup = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.groupService.removeTeamFromGroup(parseInt(id), parseInt(teamId));
  ...
  public getGroupTeams = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const teams = await this.groupService.getGroupTeams(parseInt(id));
  ...
  public getGroupStandings = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params;
      const standings = await this.groupService.getGroupStandings(parseInt(id));
