...
import { PayerData } from '../../services/championship/register.service';
...
export const update_payment = async (_options: any, parentModule: any, value: Keys, tenant: string, dataUser: DataUser) =>
    await updatePayment(value, tenant, dataUser)

export const generate_link = (_options: any, parentModule: any, purchaseData: any, tenant: string, dataUser: DataUser) =>
...
export const get_order = async (_options: any, parentModule: any, value: any, tenant: string, dataUser: DataUser) =>
